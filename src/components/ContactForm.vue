      ...
      <div class="row gx-5 mx-4 my-5 d-flex justify-content-center" >
        <div class="col-md-5 my-2" >
          <div class="row" style="box-shadow: 0 5px 15px 0px rgba(0,0,0,0.6);">
            ...
            <div class="container d-flex flex-column justify-content-center text-center contact-con" >
              <ul class="list-unstyled text-decoration-none">
                <li>
                  <a href="https://rwayisibongile@gmail.com" target="_blank" class="svg-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M464 64C490.5 64 512 85.49 512 112C512 127.1 504.9 141.3 492.8 150.4L275.2 313.6C263.8 322.1 248.2 322.1 236.8 313.6L19.2 150.4C7.113 141.3 0 127.1 0 112C0 85.49 21.49 64 48 64H464zM217.6 339.2C240.4 356.3 271.6 356.3 294.4 339.2L512 176V384C512 419.3 483.3 448 448 448H64C28.65 448 0 419.3 0 384V176L217.6 339.2z"/></svg>
                    <p >rwayisibongile@gmail.com</p>
                  </a>
                </li>
                <hr>
                <li>
                  <a href="https://github.com/elignobis" class="svg-icon" target="_blank">
                    ...
                    <p >Github:Elignobis</p>
                  </a>
                </li>
                <hr>
                <li>
                  <a href="https://codepen.io/elignobis" class="svg-icon" target="_blank" >
                    ...
                    <p >Codepen:elignobiS</p>
                  </a>
                </li>
                <hr>
                <li>
                  <a href="https://twitter.com/elignobisu" target="_blank" class="svg-icon">
        ...
        <div class="col-md-5 my-2">
          <div class="row" style="box-shadow: 0 5px 15px 0px rgba(0,0,0,0.6);">
            ...
            <form class="form form-con" action="https://formspree.io/f/myyobvqb" method="post">
              ...
              <div class="row">
                <div class="my-3">
                  <textarea name="message" id="message" class="h-100 w-100" placeholder=" Type Message"></textarea>
                </div>
              </div>
              <div class="row">
                <div class="my-3">
